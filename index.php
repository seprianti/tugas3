...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card">
      <img src="A.man (1).jpeg" class="card-img-top" height="400px">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="John Wick 2.jpeg" class="card-img-top" height="400px">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="Dungeons Dragons (3).jpeg" class="card-img-top" height="400px">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="Bed rest(4).jpeg" class="card-img-top" height="400px">
      <div class="card-body">
...
Saat Mary menggali informasi tentang The Artist yang gila tapi brilian, ia dan Jake justru terjebak dalam permainan kucing tikus yang kejam. Mereka harus berpacu dengan waktu agar tetap selangkah lebih maju dari The Artist dan sang peniru.</p>
  ...
  <div class="col">
    <div class="card">
      <img src="Cred III (6).jpeg" class="card-img-top" height="400px">
      <div class="card-body">
